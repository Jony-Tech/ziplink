  ...
  return (
   <div>
        ...
        <div className="flex flex-col justify-center h-screen items-center">
            <h2 className="font-bold text-xl">Crea tu cuenta</h2>
            ...
            <form className="flex flex-col w-1/3">
                ...
                <input id="passwordConfirm" type="password" className="border px-2 py-1 rounded w-full" placeholder="Confirma tu contraseña"/>

                <input type="submit" className="bg-slate-900 px-2 py-1 text-white rounded-md mt-4 w-full whitespace-normal" value="Crear cuenta"/>
            </form>
